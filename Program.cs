...
namespace DontForgetToStoreIt.sln
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // We've got Convert.ToDouble down but meaningingOfLifeAndEverything is an INT
            ...
            //Console.WriteLine("The circumerence of life is " +( 2 * pi * meaningOfLifeAndEverything));
        }
    }
